...
var vl = [195,252,423,545,618,691]
...
function getAt(me){
    ...
    if($(tr).find("[name='thickness']").val() == "" || $(tr).find("[name='exWidth']").val() < 1 || s1 < 1 || s2 < 1 || c < 1 ){
...
function send_email(){	
    ...
    $.ajax({
        data : queryString,
        type : 'post',
        url : 'https://script.google.com/macros/s/AKfycbzLTxPLe8KJvpxAG3QCF0cAjXiYLSkKTYUkr9d3wzOKRx74nVjlqmgHWuQrvmWZrUwS/exec',
        dataType : 'json',
